...
export const HamburgerMenu: React.FC<HamburgerMenuProps> = ({ isOpen, onClose }) => {
  return (
    <div className={`fixed top-0 left-0 w-64 h-full bg-black transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out z-50`}>
      <div className="p-6">
        <button onClick={onClose} className="text-[#E2DFDA] hover:text-white transition-colors">
      ...
      <nav className="">
        <Link href="/" className="flex items-center px-6 pb-4 py-2 text-[#E2DFDA] hover:bg-gray-800 transition-colors" onClick={onClose}>
        ...
        <Link href="/explore" className="flex items-center px-6 py-4 text-[#E2DFDA] hover:bg-gray-800 transition-colors" onClick={onClose}>
          <svg className="mr-4" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <Link href="/inventory" className="flex items-center px-6 py-4 text-[#E2DFDA] hover:bg-gray-800 transition-colors" onClick={onClose}>
          <svg className="mr-4" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
